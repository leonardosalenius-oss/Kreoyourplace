# KREO V36.05 PRESENZE UNIFICATE - generated by ChatGPT
...
def v36_registra_presenza(cliente_id, accesso_id=None, tipo_presenza="PRESENZA_VALIDA", scala_lezione=True, motivo="", note=""):
    """
    V36.05: il check-in usa il motore unico presenze.
    ...
    try:
        ...
        return False, f"Errore registrazione presenza V36.05: {e}"
...
# ============================================================
# KREO V36.05 - Reception navigation safe router
# ============================================================
...
def kreo_reception_open(view_name):
    """
    V36.05: apre sottoviste senza toccare chiavi widget del menu laterale.
    """
...
def kreo_render_back_to_reception(label="⬅️ Torna alla Reception"):
    """
    V36.05: disattivato nelle sottoviste per evitare doppio bottone.
...
def main():
    # V36.05 safe return bridge: handled before menu rendering when possible.
    ...
    with col_title:
        ...
        st.caption(f"Database cloud Supabase | Accesso: {user_label()} | Ruolo: {current_user().get('ruolo', '') if current_user() else ''} | Launch Stable V36.05")
