# KREO V36.04 PRESENZE UNIFICATE - generated by ChatGPT
...
def v36_registra_presenza(cliente_id, accesso_id=None, tipo_presenza="PRESENZA_VALIDA", scala_lezione=True, motivo="", note=""):
    """
    V36.04: il check-in usa il motore unico presenze.
    ...
    try:
        ...
        return False, f"Errore registrazione presenza V36.04: {e}"
...
# ============================================================
# KREO V36.04 - Reception navigation safe router
# ============================================================

def kreo_reception_clear_navigation():
    """
    Reset forte della navigazione Reception.
    Corregge il caso in cui Accesso tornello / Cliente 360 / sottoviste restano bloccate.
    """
    keys_to_clear = [
        "reception_view",
    ...
    # Queste sono le chiavi realmente usate dal menu V32.
    st.session_state["v32_macro_nav"] = "🛎️ Reception"
    st.session_state["v32_sub_nav"] = "🏠 Reception Center"
    st.session_state["kreo_force_menu"] = "🏠 Reception Center"
    st.session_state["kreo_area"] = "🛎️ Reception"
    st.session_state["kreo_menu"] = "🏠 Reception Center"
...
def main():
    ...
    with col_title:
        ...
        st.caption(f"Database cloud Supabase | Accesso: {user_label()} | Ruolo: {current_user().get('ruolo', '') if current_user() else ''} | Launch Stable V36.04")
